...
## 설치 방법
Chrome 웹 스토어에서 받을 수 있습니다.

https://chrome.google.com/webstore/detail/tokana/mkkpjlinnkmicaphkcippcfokojjjjdh

또는 수동으로 크롬 주소에서 `chrome://extensions/`에 들어갑니다. 개발자 모드를 켜고 `압축해제된 확장 프로그램을 로드합니다.`를 클릭합니다. 해당 리포지토리의 파일들이 있는 폴더를 선택합니다.
